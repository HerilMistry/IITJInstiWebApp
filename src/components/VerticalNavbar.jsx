...
const VerticalNavbar = () => {
  const options = ['home','mess menu','Bus schedule','mess menu','mess menu','mess menu','mess menu']

  return (
    <div className='w-[307px] h-screen pt-[12px]'>
      <div className='flex items-center'>
        ...
        <span className='font-semibold text-2xl text-[#7B90B5] bricolage-grotesque'>
          Mess Menu
        </span>
      </div>
      <div>
